...
export function Contact() {
    ...
    return (
        <section id="contact" className="section-container pt-32 pb-32">
            <div className="bg-foreground text-background border-brutal shadow-brutal relative overflow-hidden flex flex-col md:flex-row">
                
                {/* Left Side: Big Text */}
                <div className="flex-1 p-8 md:p-16 border-b-brutal md:border-b-0 md:border-r-brutal border-background flex flex-col justify-between relative bg-[url('data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iNDAiIGhlaWdodD0iNDAiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PGNpcmNsZSBjeD0iMjAiIGN5PSIyMCIgcj0iMSIgZmlsbD0iI2ZmZiIgZmlsbC1vcGFjaXR5PSIwLjA1Ii8+PC9zdmc+')]">
                    ...
                    <h2 className="font-display text-6xl sm:text-7xl lg:text-[8rem] font-black uppercase leading-[0.8] tracking-tighter mt-12 mb-12">
                        {contact.heading} <br />
                ...
                <div className="w-full md:w-[450px] flex flex-col">
                    ...
                    <a href={`mailto:${contact.email}`} className="flex-1 p-8 md:p-12 border-b-brutal border-background flex flex-col justify-center group hover:bg-accent transition-colors relative overflow-hidden">
                        ...
                        <span className="font-display text-3xl sm:text-4xl font-black uppercase truncate">{contact.email}</span>
                    </a>

                    <a href={contact.facebook} target="_blank" rel="noopener noreferrer" className="flex-1 p-8 md:p-12 border-b-brutal border-background flex flex-col justify-center group hover:bg-[#1877F2] hover:text-white transition-colors relative overflow-hidden">
                        <ArrowUpRight size={48} strokeWidth={2} className="absolute top-8 right-8 group-hover:scale-125 group-hover:translate-x-2 group-hover:-translate-y-2 transition-transform" />
                        <span className="font-mono text-sm font-bold uppercase tracking-widest opacity-60 mb-2">Connect on</span>
                        <span className="font-display text-3xl sm:text-4xl font-black uppercase">Facebook</span>
                    </a>
                    ...
                    <div className="p-8 md:p-12 bg-background text-foreground flex flex-col justify-center relative group">
                        ...
                        <div className="flex items-center justify-between gap-4">
                            <span className="font-display text-3xl sm:text-4xl font-black uppercase tracking-widest truncate">{contact.phone}</span>
